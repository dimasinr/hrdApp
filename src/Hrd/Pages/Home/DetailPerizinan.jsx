...
function DetailPerizinan() {
    ...
    const getSubmission = () => {
      ...
      .then((response) => {
        ...
        setPermissionType(res.permission_type)
    ...
    React.useEffect(() => getSubmission(), [id])

    const approvalSubmission = async e => {
        try{
            const formData = new FormData();
            formData.append("employee", employee.pk);
      ...
      const handleApproval = () => {
        Swal.fire({
            ...
            text: "Anda tidak dapat mengedit nya lagi",
            icon: 'warning',
                        ...
                        <div className="card shadow-card" style={{ border: 'none' }}>
                            <div className="card-body">
                                ...
                                <Box sx={{ mt:2, display:'flex' }}>
                                    <TextField fullWidth disabled sx={{ mr:2 }} value={employee && employee.name} type="text" label='Nama' variant='filled' />
                                    <TextField fullWidth disabled value={employee && employee.division} type="text" label='Bagian' variant='filled' />
                                </Box>
                                <Box sx={{ mt:2, display: 'flex' }}>
                                    <span>Jenis Cuti/Izin</span> : &nbsp;
                                    <FormControl>
                                    <RadioGroup
                                        aria-labelledby="permissionType"
                                        name="permissionType"
                            ...
                            <React.Fragment>
                             ...
                             <TextField value={hours(lembur_end)} onChange={e => setLemburEnd(e.target.value)} disabled fullWidth type="text" label='Sampai Jam' variant='filled' />
                                ...
                                <span className='mt-4 mb-2'>Persetujuan Atasan</span>
                                <Box sx={{ mt:2, display: 'flex' }}>
                                ...
                                <div className="d-flex justify-content-between mt-4 mb-4">
                                    <small className="text-secondary">Sisa Cuti Karyawan Ini : {employee.sisa_cuti && employee.sisa_cuti} 
                                    </small>
                                    {
                                        permission_pi === 'disetujui'?
                                        <button onClick={handlePenghapusan} className='btn text-danger'>
                                            Hapus Pengajuan
                                        </button>
                                        : 
                                        <button onClick={handleApproval} className='btn btn-primary'>Submit</button>
                                    }
                                </div>
                                    <small>
