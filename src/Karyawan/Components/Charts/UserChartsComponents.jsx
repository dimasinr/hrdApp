...
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer,BarChart, Pie, PieChart, Cell, ComposedChart, Legend, Bar, Line } from 'recharts';
...
export const UserChartComponents = ({ chartData }) => {
    return (
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart width={730} height={250} data={chartData}
            ...
            <Tooltip />
            <Area type="monotone" dataKey="value" stroke="#8884d8" fillOpacity={12} fill="url(#colorUv)" />
            <Area type="monotone" dataKey="actual_value" stroke="#FF8042" fillOpacity={12} fill="url(#colorPv)" />
            </AreaChart>
      </ResponsiveContainer>
    );
  };
  ...
  export const UserChartBarComponents = ({ chartData }) => {
    return (
      <ResponsiveContainer width="100%" height={245}>
